...
def plot_word_cloud(article_texts):
    ...
    # Display the description below the plot
    st.write(f"- **The word cloud shows the most common keywords found in news articles related to **Trump/Harris**.**")
...
def plot_sentiment_histograms(polarities, subjectivities):
    ...
    st.write("- **Polarity** measures the sentiment of the text, ranging from -1 (completely negative) to 1 (completely positive). A score close to 0 indicates neutrality.")
    st.write("- **Subjectivity** measures how opinion-based a text is, ranging from 0 (completely objective) to 1 (completely subjective). Lower values indicate more factual writing, while higher values suggest more personal opinion or bias.")
...
def plot_sentiment_table(article_titles, polarities, subjectivities, polarity_classes, subjectivity_classes):
    ...
    st.write("- These are the 20 latest articles related to **Trump/Harris** collected from **The Guardian**. ")
    st.write("- This table shows the title of the articles, polarity category and score, and subjectivity category and score. Polarity measures how positive or negative an article is, while subjectivity indicates how opinion-based or factual it is.")
